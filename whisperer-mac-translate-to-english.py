...
# - Press Option key (⌥) during recording to enable translation to English
...
def main():
    try:
        ...
        print("Press Option key (⌥) while recording to translate to English")
                ...
                with open("output.flac", "rb") as file:
                    ...
                    if translate:
                        ...
                        result = openai.chat.completions.create(
                            model="gpt-4o-mini",
                            messages=[
                                {"role": "system", "content": "You translate the input text to English. You only output the translated text and nothing else."},
